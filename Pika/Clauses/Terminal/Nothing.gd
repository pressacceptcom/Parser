tool
class_name PressAccept_Parser_Pika_Nothing
...
static func nothing_instantiate() -> PressAccept_Parser_Pika_Nothing:
...
func __get_script():
	...
	return 'res://addons/PressAccept/Parser/Pika/Clauses/Terminal/Nothing.gd'
